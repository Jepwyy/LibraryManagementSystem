Public Class frmListBorrower
    ...
    Private Sub btnReqBorrow_Click(sender As Object, e As EventArgs) Handles btnReqBorrow.Click
        Try
            frmReqBorrow.txtBorrowerId.Text = dtgList.CurrentRow.Cells(0).Value
            Me.Close()
        Catch ex As Exception
