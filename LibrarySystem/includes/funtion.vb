...
Module funtion
    ...
    End Sub
    Public Sub timeOfresearch(ByVal id As Integer, ByVal hoursinterval As Integer)



        If hoursinterval >= 168 Then
        ...
        'End If
    End Sub
    Public Sub timeOfPhotocopy(ByVal id As Integer, ByVal hoursinterval As Integer)

        If hoursinterval >= 1 Then
    ...
    Public Sub formClose()
        ...
        frmCategory.Close()
        frmDashboard.Close()
        frmLibraryCard.Close()
        frmListBooks.Close()
        frmListBorrower.Close()
        frmListofBooks.Close()
        frmLogsuser.Close()
        frmPayments.Close()
        frmReport.Close()
        frmReturn.Close()
    ...
    Public Sub print(ByVal sql As String, ByVal DTG As Object)
        Try
            dt = New DataTable
            con.Open()
            With cmd
